...
## Education
- **BSc in Computer Science** — ASOIU (2022–2026)
...
- 🔹 **[CNN-Image-Classification](https://github.com/Tural-Kazimov/cifar10-cnn-model-comparison)** — Image classification using CNN (PyTorch)
---
